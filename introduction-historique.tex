...
\begin{objectifs}
\item Justifier l'utilisation d'un système de tarification basée sur
  l'expérience dans un contexte d'assurance IARD.
\item Expliquer le rôle des modèles de crédibilité dans la
  tarification basée sur l'expérience.
\item Nommer les contributions scientifiques les plus importantes
  entre 1914 et 1970 dans le développement de la théorie de la
  crédibilité.
\item Établir le lien entre l'approche subjective des probabilités et
  la théorie de la crédibilité.
\item Expliquer les différences entre la crédibilité de stabilité et
  la crédibilité de précision.
\end{objectifs}
...
Il existe de nombreux systèmes de tarification basée sur l'expérience,
...
\tipbox{Nous pourrions tout à fait formuler
  l'\autoref{ex:introduction-historique:simplifie} dans un contexte
  tout autre que l'assurance. En effet, le
  \autoref{tab:introduction-historique:simplifie:10} établit
  simplement si un «évènement» est survenu ou non en dix «expériences»
  et pour dix «sujets». Le but de l'exercice consiste à estimer la
  probabilité qu'un évènement survienne lors d'une onzième expérience
  en sachant que les sujets ne sont pas «équivalents». Ceci démontre
  que nous pouvons utiliser les modèles de crédibilité dans tout
...
la loi, certaines critiques de cinéma sont crédibles alors que d'autres
...
Whitney fut de plus critiqué par \citet{Fisher:Whitney:discussion:1919}
...
linéaire qu'elles n'en seraient que de simples dérivés. Karl
