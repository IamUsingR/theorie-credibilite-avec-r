...
\tipbox{La distribution de $S$ n'étant en général pas symétrique, il
  serait légitime de nous demander s'il est correct d'utiliser le
  Théorème central limite (TCL) pour calculer le seuil de crédibilité
  complète. En fait, puisque le critère impose que la distribution de
  $S$ soit très concentrée autour de sa moyenne, elle s'en trouve
  presque symétrique et le TCL s'avère donc bien assez précis
  \citep{Goulet:limitedfluctuation:1998}.}
