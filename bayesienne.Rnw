...
\item La combinaison normale/normale est celle considérée par
  \cite{Whitney:1918}, mais aussi celle pour laquelle les formules
  sont les plus compliquées. Cela explique sans doute en partie que
  \citeauthor{Whitney:1918} ait éventuellement recommandé de fixer la
  constante $K$ au jugement.
